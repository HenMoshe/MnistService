...
import minstServiceProto_pb2 as minstServiceProto__pb2
...
class MnistServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetTrainingSamples = channel.unary_stream(
                ...
                request_serializer=minstServiceProto__pb2.DataRequest.SerializeToString,
                response_deserializer=minstServiceProto__pb2.Sample.FromString,
                )
...
def add_MnistServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetTrainingSamples': grpc.unary_stream_rpc_method_handler(
                    ...
                    request_deserializer=minstServiceProto__pb2.DataRequest.FromString,
                    response_serializer=minstServiceProto__pb2.Sample.SerializeToString,
            ),
    }
...
class MnistService(object):
    ...
    def GetTrainingSamples(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/MnistService/GetTrainingSamples',
            minstServiceProto__pb2.DataRequest.SerializeToString,
            minstServiceProto__pb2.Sample.FromString,
